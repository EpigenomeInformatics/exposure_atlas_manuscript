...
# Run methylTFR JASPAR2020 motifs analysis using pseudobulks
#####################################################################
...
out.dir <- "/icbb/projects/igunduz/DARPA_analysis/methyltfr_041023/jaspar2020/"
if (!dir.exists(out.dir)) {
  dir.create(out.dir)
}
comparasions <- c("C19_ctrl","C19_sev","C19_mild","HIV_acu","HIV_ctrl","HIV_chr","OP_low","OP_med","OP_high","Influenza_ctrl","Influenza_d30")
...
for (comp in comparasions) {
    for(cell in cells){
      if (!file.exists(paste0(out.dir, cell,"_",comp,"_deviations.RDS"))) {
        ...
        rm(deviations);ChrAccR:::cleanMem()
